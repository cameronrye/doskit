...
describe('DemoSelector', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render app descriptions', () => {
      render(<DemoSelector onSelect={mockOnSelect} />);
      expect(screen.getByText(/A legendary demo by Future Crew/i)).toBeInTheDocument();
      expect(screen.getByText(/A music tracker application/i)).toBeInTheDocument();
    });
  ...
  describe('App selection', () => {
    ...
    it('should clear error when selecting a new app', () => {
      ...
      const loadButton = screen.getByRole('button', { name: /Load Application/i });
      ...
      // Select another app
      const anotherAppCard = screen.getByText('Impulse Tracker').closest('.app-card');
  ...
  describe('App loading', () => {
    ...
    it('should call onSelect with selected app after successful load', async () => {
      render(<DemoSelector onSelect={mockOnSelect} />);
    ...
    it('should show loading state while loading', async () => {
      vi.mocked(loadZipArchive).mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
    ...
    it('should handle loading errors', async () => {
      ...
      vi.mocked(loadZipArchive).mockRejectedValueOnce(new Error(errorMessage));
